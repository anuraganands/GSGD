...
function GSGD
    ...
    ropeTeamSz = 5; %[1:10] %neighborhood size => increase rho value when the dataset is very noisy.
...
%     Wmom = zeros(d,1); %momentum, currently working with Wsgd variable....
    ...
    while t <= T 
        ...
        (ve, pe, omPlusScore, omPlusLevel, omMinuScore,...
        omMinusLevel)
        ...
        pe = ve;
        idx = setdiff(idx, consistentIdx); %remove these ones now for this epoch.
